...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	fa1 = new Fa({ props: { icon: faVimeo }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-ise6if");
    			add_location(h1, file, 6, 2, 142);
    			attr_dev(a0, "href", "https://www.linkedin.com/in/luke-gaines-943066138/");
    			attr_dev(a0, "class", "svelte-ise6if");
    			add_location(a0, file, 8, 3, 185);
    			attr_dev(div0, "class", "spacer svelte-ise6if");
    			add_location(div0, file, 11, 3, 287);
    			attr_dev(a1, "href", "https://vimeo.com/callistoentertainment");
    			attr_dev(a1, "class", "svelte-ise6if");
    			add_location(a1, file, 12, 3, 317);
    			attr_dev(div1, "id", "links");
    			attr_dev(div1, "class", "svelte-ise6if");
    			add_location(div1, file, 7, 2, 165);
    			attr_dev(header, "class", "svelte-ise6if");
    			add_location(header, file, 5, 1, 131);
    			if (!src_url_equal(iframe.src, iframe_src_value = "https://player.vimeo.com/video/675684038?h=52de933eac&badge=0&autopause=0&player_id=0&app_id=58479")) attr_dev(iframe, "src", iframe_src_value);
    			...
    			attr_dev(iframe, "title", "Student Production Reel");
    			add_location(iframe, file, 19, 15, 470);
    			attr_dev(div2, "id", "vid");
    			attr_dev(div2, "class", "svelte-ise6if");
    			add_location(div2, file, 19, 1, 456);
    			if (!src_url_equal(script.src, script_src_value = "https://player.vimeo.com/api/player.js")) attr_dev(script, "src", script_src_value);
    			add_location(script, file, 19, 325, 780);
    			attr_dev(main, "class", "svelte-ise6if");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Fa, faLinkedin, faVimeo });
    	return [];
    }
